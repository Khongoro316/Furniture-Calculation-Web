...
exports.getAuditLogs = exports.exportExcel = exports.workersReport = exports.calculationsReport = exports.materialsReport = exports.financeReport = exports.ordersReport = void 0;
...
exports.ordersReport = ordersReport;
const financeReport = async (req, res) => {
    try {
        ...
        if (from || to) {
            where.paid_at = {};
            if (from)
                where.paid_at.gte = new Date(from);
            if (to)
                where.paid_at.lte = new Date(to);
        }
...
exports.financeReport = financeReport;
const materialsReport = async (req, res) => {
    try {
        const materials = await prisma_1.default.materials.findMany({
...
exports.materialsReport = materialsReport;
const calculationsReport = async (req, res) => {
    try {
...
exports.calculationsReport = calculationsReport;
const workersReport = async (req, res) => {
    try {
...
exports.workersReport = workersReport;
