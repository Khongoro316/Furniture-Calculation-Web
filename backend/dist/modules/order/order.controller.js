...
exports.addPayment = exports.updateStatus = exports.assignOrder = exports.createOrder = exports.getOrderById = exports.getMyOrders = exports.getOrders = void 0;
...
const createOrder = async (req, res) => {
    try {
        const { calculation_id, note, total_amount, items = [], // [{ material_id, qty, unit, unit_price }]
...
const assignOrder = async (req, res) => {
    try {
        ...
        if (!worker_id)
            return res.status(400).json({ message: 'Ажилтан сонгоно уу' });
